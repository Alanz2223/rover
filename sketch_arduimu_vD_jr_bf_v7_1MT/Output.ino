...
void printdata(void)
{    
  //static float oldNorth = 0 ;
  //static float oldEast = 0 ;
...
*/
                ...
                if ( count > 0 )
                {
                  if ( firstTime )
                  {
                    //Serial.println ( "delta,N..,N.,N,E..,E.,E,Gyro_Z,Mag_X,Mag_Y," 
                    //  "Mag_Z,Accel_X,Accel_Y ") ;
                    firstTime = 0 ;
                    startTime = millis ( ) ;
                  }
                  count = 0 ;
                  ...
                  startTime = millis ( ) ;
                  //Serial.print ( "|" ) ;
                  //Serial.print ( "BF/JR positions: " ) ;
                  //Serial.print ( northPosition ) ;
                  //Serial.print ( "," ) ;
                 
                  //Serial.print (Accel_Scale_fps_jr(Accel_Vector[2]) ) ;
                  //Serial.print(",");
                  
                  
                  // Print DCM in compact notation
                /*
                  Serial.print(convert_to_dec(DCM_Matrix[0][0]));
      		Serial.print (",");
      		Serial.print(convert_to_dec(DCM_Matrix[0][1]));
      		...
      		Serial.print (",");
                */  
                  ...
                  Serial.print ( "," ) ;
                  Serial.print ( Ndotdot ) ;
                  Serial.print ( "," ) ;
                  Serial.print ( Ndot ) ;
                  Serial.print ( "," ) ;
                  Serial.print ( N ) ;
                  Serial.print ( "," ) ;
                  Serial.print ( Edotdot ) ;
                  Serial.print ( "," ) ;
                  Serial.print ( Edot ) ;
                  Serial.print ( "," ) ;
                  //Serial.print ( eastPosition ) ;
                  //Serial.print ( "," ) ;
                  Serial.print ( E ) ;
                  Serial.print ( "," ) ;
                  */
		  ...
		  Serial.print (Accel_Vector[0] ) ;
                ...
                /*
                Serial.print ( "," ) ;
                Serial.print ( northPosition - oldNorth ) ;
                Serial.print ( "," ) ;
                Serial.println ( eastPosition - oldEast ) ;
                oldNorth = northPosition ;
                oldEast = eastPosition ;
                
                // print new calculations, too.
                Serial.print ( "|" ) ;
                //Serial.print ( "BF/JR positions: " ) ;
                Serial.print ( northPosition ) ;
                Serial.print ( "," ) ;
...
// Hacked by JR and B F to not scale result
